...
public class AI_actual {
    ...
    public class chatterbot  {
        ...
        static String KnowledgeBase[][][] = {
                ...
                {{"LIGHT ON","TURN ON THE LIGHT" ,"PLEASE TURN ON LIGHT" ,"ON LIGHT"},
                        {"YES OFCOURSE , IT WILL BE TURNED ON",
                                " LIGHTS WILL BE TURNED ON",
                                "SURE IT WILL TURN ON "}
                },
                {{"LIGHT OFF","TURN OFF LIGHT" ,"PLEASE TURN OFF LIGHT" , "OFF LIGHT"},
                        {"YES OFCOURSE , IT WILL BE TURNED OFF",
                                " LIGHTS WILL BE TURNED OFF",
                                "SURE IT WILL TURN OFF"}
                },
        ...
        static void preprocess_response()
        {
